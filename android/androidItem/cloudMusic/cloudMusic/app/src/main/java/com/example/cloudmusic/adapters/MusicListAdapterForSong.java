...
import com.example.cloudmusic.utils.DateTimeUtils;
 ...
 * @author llw
 */
public class MusicListAdapterForSong extends BaseQuickAdapter<Song, BaseViewHolder> {

    public MusicListAdapterForSong(int layoutResId, @Nullable List<Song> data) {
